...
return [
    ...
    'epub_unknown' => '未知',
    'reader_markers' => '書籤',
    'reader_marker_default' => '書籤',
    'reader_marker_add' => '在此處加入書籤',
    'reader_marker_edit' => '編輯名稱',
    'reader_marker_delete' => '刪除',
    'reader_marker_save' => '儲存',
    'reader_marker_cancel' => '取消',
    'reader_marker_name_placeholder' => '書籤名稱（選填）',
    'reader_marker_added' => '已加入書籤。',
    'reader_marker_updated' => '已更新書籤。',
    'reader_marker_deleted' => '已刪除書籤。',
    'reader_marker_limit' => '每本書最多可加入100個書籤。',
    'reader_marker_error' => '書籤操作失敗。',
    'reader_marker_empty' => '尚未加入書籤。',
    'reader_marker_page' => '第%s頁',
    'reader_marker_progress' => '進度 %s%%',
    'reader_marker_section' => '第%s章',
    'reader_marker_cluster' => '%s個書籤',
    ...
    'archive_expanding' => '壓縮檔解壓中',
    'archive_open_failed' => '壓縮檔解壓失敗',
    
    // 直播串流相關錯誤
    'guest_not_allowed' => '訪客用戶無法使用直播串流功能',
    ...
    'guest_not_allowed_detail' => '伺服器設定不允許訪客用戶使用直播串流功能。請下載檔案或直接播放',
